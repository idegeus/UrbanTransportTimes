...
docker run -p 8989:8989 -v /Users/ivo/Desktop/DUTTv2/1-data:/1-data --env JAVA_OPTS="-Xmx8g -Xms8g" --entrypoint /bin/bash israelhikingmap/graphhopper -c "cd ../ && java -Xmx8g -Xms8g -jar /graphhopper/*.jar server /1-data/2-gh/config-duttv2.src.yml"
